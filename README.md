...
~~~
- DefaultInput.ini の MoveUp, MoveRight, Thrust に GenericUSBController_Axis<N> を追加 (Added GenericUSBController_Axis<N> to MoveUp, MoveRight, Thrust in DefaultInput.ini)
~~~
